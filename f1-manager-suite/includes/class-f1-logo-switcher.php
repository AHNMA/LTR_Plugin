...
class F1_Logo_Switcher {
	...
	public function render_admin_page() {
		require_once plugin_dir_path( __FILE__ ) . 'admin/logo-admin.php';
	}
	...
	public function enqueue_assets() {
		// CSS
		wp_enqueue_style( 'f1-logo-switcher', plugin_dir_url( __FILE__ ) . '../assets/css/f1-logo-switcher.css', array(), '1.0.0' );

		// JS (in HEAD for fast swap)
		wp_enqueue_script( 'f1-logo-switcher', plugin_dir_url( __FILE__ ) . '../assets/js/f1-logo-switcher.js', array(), '1.0.0', false );
