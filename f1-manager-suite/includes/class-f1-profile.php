...
class F1_Profile {
	...
	public function enqueue_assets() {
		wp_enqueue_style( 'f1-profile', plugin_dir_url( __FILE__ ) . '../assets/css/f1-profile.css', array(), '1.0.0' );
		wp_enqueue_script( 'f1-profile', plugin_dir_url( __FILE__ ) . '../assets/js/f1-profile.js', array(), '1.0.0', true );
	}
	...
	private function render_privacy_confirm() {
		...
		require plugin_dir_path( __FILE__ ) . 'frontend/privacy-confirm-view.php';
	}
	...
	private function render_password_reset() {
		...
		require plugin_dir_path( __FILE__ ) . 'frontend/password-reset-view.php';
	}
	...
	public function render_shortcode( $atts ) {
		...
		ob_start();
		require plugin_dir_path( __FILE__ ) . 'frontend/profile-view.php';
		return ob_get_clean();
	}
