...
class F1_Ticker {
    ...
    public function render_admin_page() {
        require_once F1_MANAGER_SUITE_PATH . 'includes/admin/ticker-admin.php';
    }
    ...
    public function enqueue_assets() {
        global $post;
        if ( ! is_a( $post, 'WP_Post' ) || ! has_shortcode( $post->post_content, 'f1_wm_ticker' ) ) return;

        wp_enqueue_style( 'f1-ticker', F1_MANAGER_SUITE_URL . 'assets/css/f1-ticker.css', array(), '1.0.0' );
        wp_enqueue_script( 'f1-ticker', F1_MANAGER_SUITE_URL . 'assets/js/f1-ticker.js', array( 'jquery' ), '1.0.0', true );
