...
class F1_Countdown {
	...
	public function render_admin_page() {
		require_once plugin_dir_path( __FILE__ ) . 'admin/countdown-admin.php';
	}
	...
	public function enqueue_assets() {
		...
		wp_enqueue_style( 'f1-countdown', plugin_dir_url( __FILE__ ) . '../assets/css/f1-countdown.css', array(), '1.0.0' );
		wp_enqueue_script( 'f1-countdown', plugin_dir_url( __FILE__ ) . '../assets/js/f1-countdown.js', array(), '1.0.0', true );
	...
	public function get_next_event() {
		...
		// 2. Automatic CPT Lookup (Legacy Logic)
		$tz = wp_timezone();
